...
{
    public class CreateExaminationServiceCommandValidator : AbstractValidator<CreateExaminationServiceCommand>
    {
        public CreateExaminationServiceCommandValidator()
        {
    ...
    public class ServiceTestParameterDtoValidator : AbstractValidator<ServiceTestParameterDto>
    {
        public ServiceTestParameterDtoValidator()
        {
