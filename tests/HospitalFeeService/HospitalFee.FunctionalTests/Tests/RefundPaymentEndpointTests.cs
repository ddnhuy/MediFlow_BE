...
namespace HospitalFee.FunctionalTests.Tests
{
    public class RefundPaymentEndpointTests : BaseFunctionalTest, IAsyncLifetime
    {
        ...
        public async Task RefundPayment_WithValidPaidItems_ReturnsCreated()
        {
            ...
            var paidService = new ServiceRequestDetail { ReceptionId = reception.Id, RequestNumber = "REQ-001", ServiceId = 101, PaymentStatus = PaymentStatusForItem.Paid, UnitPrice = 100, Quantity = 1, InvoiceDate = DateTime.UtcNow };
